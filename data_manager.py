...
# ---------- Save Today’s Pick ----------
def save_today_pick(recipe, item_type, repo=None, branch="main", history_file="history.csv"):
    df = load_history(repo, branch=branch)
    ...
    # Add the new entry
    new_row = {"Date": today, "Recipe": recipe, "Item Type": item_type}
